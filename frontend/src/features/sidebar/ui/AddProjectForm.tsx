  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="w-full flex items-center gap-2 px-2 py-2 rounded-xl hover:bg-white/10 text-white/40 hover:text-white/70 transition-all"
      >
        <Plus className="w-4 h-4 flex-shrink-0" />
        <span className="text-xs font-medium">{tr.newProject}</span>
      </button>
    )
  }
